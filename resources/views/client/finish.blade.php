...
<html lang="en">
<head>
    <meta http-equiv='refresh' content='2; URL={{route('client.main')}}'>
    <meta charset="UTF-8">
...
<h1 style="font-weight: 700;
    ...
    text-align: center;
    margin-top: 100px;
    color: red;"> Xác Nhận Đặt Vé</h1>
<i class="fa-solid fa-circle-check icon" style="font-size: 100px" styke="justify-content: center;
    margin-top: 30px;
    color: red;
    margin-left: 48%;"></i>
